...
## Доказанные правила (v1→v15)
1. ВСЕГДА early stopping на полном val (523K) — НЕ субсемпл, НЕ фиксированные iter
2. НЕ добавлять фичи бездумно — каждый раз ухудшало LB (v2, v11, v15)
...
- Shift ПЕРВАСИВНЫЙ: удаление/нормализация фич не помогает
...
- Pretest profiles существуют но НЕ используются в v14-C
